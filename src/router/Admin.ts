import IconList from '../pages/admin/IconList.tsx';
import IconDetail from '../pages/admin/IconDetail.tsx';
import CreatorList from '../pages/admin/CreatorList.tsx';
import CreatorDetail from '../pages/admin/CreatorDetail.tsx';
import Settlement from '../pages/admin/SettlementList.tsx';
...
export {
  IconList as AdminIconList,
  IconDetail as AdminIconDetail,
  CreatorList as AdminCreatorList,
  CreatorDetail as AdminCreatorDetail,
  Settlement as AdminSettlement,
  SettlementDetail as AdminSettlementDetail,
  InquiryList as AdminInquiryList,
  InquiryDetail as AdminInquiryDetail,
